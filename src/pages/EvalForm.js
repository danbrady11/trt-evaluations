  ...
  return (
    <div className="ef-root">
      <header className="ef-header">
        <div className="ef-header-badge">TRT</div>
        <div>
          <h1 className="ef-title">Training Evaluation</h1>
          <p className="ef-subtitle">Thank you for helping us improve your technical rescue training</p>
        </div>
      </header>
      ...
      <main className="ef-main">
        ...
        <section className="ef-section">
          ...
          <textarea
            ...
            placeholder="What would make this training more effective? Equipment concerns, suggestions, or commendations?"
            value={form.comments}
